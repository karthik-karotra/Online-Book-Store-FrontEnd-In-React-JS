                    ...
                    <div className="reset-form-container">
                        <div className="reset-form">
                            <div className="reset-paragraph">
                                <p className="reset-password-paragraph" style={{opacity: 0.5}}>You can change your password for security reasons or reset it if you forget it. Reset your password here!!</p>
                            </div>
