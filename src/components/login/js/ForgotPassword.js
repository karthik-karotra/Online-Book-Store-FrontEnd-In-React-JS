                        ...
                        <div className="forgot-container">
                            <div className="forgot-email-form">
                                <div className="paragraph">
                                    <p className="forgot-password-paragraph" style={{opacity: 0.5}}>Enter your email
                                        address and we'll send you a link to reset your password</p>
                                </div>
                                <div className="forgot-textfield">
                                    ...
                                    <button className="forgot-submit-button" onClick={this.handleSubmit}>Reset
                                        Password
                                    </button>
                                </div>
                            </div>
