            ...
            <div className="verification-container">
                ...
                <div className={this.state.verificationUnsuccessfull}>
                    ...
                    <div className="token-expired">
                        ...
                        <div>
                            <div className="token-expired-message">Your account activation token is no longer valid</div>
                            <div className="token-expired-message">We'll need to re-send your authentication email</div>
                        </div>
                    </div>
